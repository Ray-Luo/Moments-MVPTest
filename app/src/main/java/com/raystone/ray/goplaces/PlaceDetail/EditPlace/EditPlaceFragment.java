 ...
 */
public class EditPlaceFragment extends android.app.Fragment implements EditPlaceContract.View{
    ...
    private EditPlaceContract.UserActionsListener mActionListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        mActionListener = new EditPlacePresenter(this);
