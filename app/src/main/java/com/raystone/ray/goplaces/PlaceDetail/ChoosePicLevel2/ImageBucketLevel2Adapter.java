...
public class ImageBucketLevel2Adapter extends BaseAdapter {
	...
	public ImageBucketLevel2Adapter(Activity act, List<ImageItem> list, Handler mHandler) {
		this.act = act;
		dataList = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			holder = new Holder();
			convertView = View.inflate(act, R.layout.level2_item, null);
