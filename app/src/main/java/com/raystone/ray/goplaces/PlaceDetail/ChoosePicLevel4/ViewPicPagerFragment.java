 ...
 */
public class ViewPicPagerFragment extends android.app.Fragment implements ViewPicContract.View {
    ...
    private ViewPicContract.UserActionsListener mActionListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mActionListener = new ViewPicPresenter(this);
    ...
    public void confirm()
    {
        ...
        if (MoveAmongFragments.editPlaceMode) {
            for (int i = 0; i < del.size(); i++) {
                FileUtils.delFile(MoveAmongFragments.editPlace.getID().toString(), del.get(i) + ".JPEG");
            }
        }
        returnToDetail();
    }
    ...
    @Override
    public void initListViews(Bitmap bm) {
        if (mListViews == null)
